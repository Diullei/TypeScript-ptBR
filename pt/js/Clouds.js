...
(function(TSSite) {
    ...
    var Clouds = (function () {
        ...
        Clouds.prototype.start = function () {
            var _self = this;
            this._last = window.animationStartTime || window.msAnimationStartTime || window.mozAnimationStartTime || window.webkitAnimationStartTime || window.oAnimationStartTime || +new Date();
            reqAnimationFrame(function (time) {
                return _self.tick(time);
            });
        };
